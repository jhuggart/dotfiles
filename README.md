...
1. `setup.sh` installs `notedmd`. Configure a provider once with `notedmd config --edit` — choose **Gemini** and paste a free [Google AI Studio](https://aistudio.google.com/) API key (Claude and Ollama also work).
